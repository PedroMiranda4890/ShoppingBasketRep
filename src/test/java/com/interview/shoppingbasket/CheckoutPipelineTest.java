...
public class CheckoutPipelineTest {
    ...
    void executeAllPassedCheckoutSteps() {
        ...
        basket.add("productCode1", "productName1",2);
        basket.add("productCode3", "productName3",2);

        basket.consolidateItems();

        List<Promotion> list = new ArrayList<>();
        //Apply 50% promotion (test PASSED)
        Promotion p1 = new PromotionFifty("productCode1");
        list.add(p1);
        //Apply 10% promotion (teste PASSED)
        Promotion p2 = new PromotionTen("productCode2");
        list.add(p2);
        //Apply 50% promotion if quantity >=2. 
        Promotion p3 = new Promotion21("productCode3");
        list.add(p3);
        ...
        double expectedRetailTotal = 47.5;
